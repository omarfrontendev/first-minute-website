...
const MainHero = ({ name, description, title, loading }) => (
    <div className="_fm-hero-section d-flex align-items-center justify-content-center flex-column position-relative">
        ...
        <h1 className="_fm-main-title mt-3 mb-2">{loading ? <Skeleton baseColor='#FFF' width={909} height={88} className="skeleton-box" /> : title}</h1>
